...
-- as generated by the wizard and added generic
-- used by BeMicro board with Cyclone III
-- clock 2 is 180 degree phase shifted, but that's only
-- true when the frequency is set to 80 MHz (factor 5)
...
BEGIN
	...
	GENERIC MAP (
		...
		clk1_phase_shift => "6250", -- this is in ps
