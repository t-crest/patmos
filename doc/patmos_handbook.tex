...
are not used otherwise. Two special registers \texttt{sxb} (\texttt{s10}) and
\texttt{sxo} (\texttt{s11}) provide the return base and return offset for exceptions.
...
\bigskip
\begin{bytefield}[leftcurly=.]{32}
  \begin{leftwordgroup}{\parbox{12em}{CFLt -- Trap}}
    \bitheader{0-31} \\
    \bitbox{1}{x} & \bitbox{4}{Pred} & \bitbox{3}{111} & \bitbox{2}{01} &
...
\bigskip
\begin{bytefield}[leftcurly=.]{32}
  \begin{leftwordgroup}{\parbox{12em}{CFLr -- \texttt{xret}}}
    \bitheader{0-31} \\
    \bitbox{1}{x} & \bitbox{4}{Pred} & \bitbox{3}{111} & \bitbox{2}{10} &
    \bitbox{5}{\bitsunused} & \bitbox{5}{Rb} & \bitbox{5}{Ro} & \bitbox{3}{\bitsunused} &\bitbox{4}{0001}
  \end{leftwordgroup} \\
\end{bytefield}
