...
First install a recent version of the Java JDK (not just the runtime).
Following packages need to be installed as well:
...
This will take some time. After building the compiler add the path
