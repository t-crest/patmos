...
First install the Mac compiler (Xcode) and the command line tools. For Linux/GCC tools and libraries
we use \code{Homebrew} as package manager. Following packages are recommended:
