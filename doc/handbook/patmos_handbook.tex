...
Like the \texttt{call}, \texttt{trap} stores return information, in
special registers \texttt{sxb} and \texttt{sxo}.
...
\todo{Any additional packages needed for Aegean?}
...
\item Automatic save of method base in a special register for a call: DONE
\item Branch into subfunction: DONE
\item Revised branch addressing modes: DONE
\item Non-delayed branches: DONE
...
\begin{bytefield}[leftcurly=.]{32}
  \begin{leftwordgroup}{\parbox{12em}{CFLri -- \texttt{xret}}}
    \bitheader{0-31} \\
    \bitbox{1}{x} & \bitbox{4}{Pred} & \bitbox{2}{11} & \bitbox{2}{00} & \bitbox{1}{d} &
