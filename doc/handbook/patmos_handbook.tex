...
In an administrator-mode Powershell, force bind the device to WSL and then attach it:

\begin{verbatim}
	usbipd bind --force -b 4-1
	usbipd attach -w -b 4-1
\end{verbatim}
...
It you want to be able to unplug the cable or turn off the FPGA, use the \texttt{-a} flag.
