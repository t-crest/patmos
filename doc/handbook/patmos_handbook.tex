...
The exception unit supports up to 32 exception vectors. Exception
vectors 0 and 1 are reserved for the ``illegal operation'' and
``illegal memory access'' faults. While exception vectors 2 to 15 can
be used freely (e.g., by the operating system), exception vectors 16
to 32 are attached to interrupts.
...
number as parameter. Similarly, \textt{intr\_clear\_pending} can be
