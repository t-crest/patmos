...
\section{Setup On Ubuntu and Mac OSX}

In the following we present the Patmos build instructions including setup of
tools in two different Ubuntu versions and for the Mac OSX.

\subsection{Setup On Ubuntu 15.10 64-Bit}
...
sudo apt-get install git openjdk-7-jdk gitk cmake make g++ texinfo flex bison \
  subversion libelf-dev graphviz libboost-dev libboost-program-options-dev ruby \
  ruby-dev liblpsolve55-dev python zlib1g-dev gtkwave gtkterm scala
\end{verbatim}
