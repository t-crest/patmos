...
# different ld/st from/to scratchpad memory
	...
	addi	r2 = r0, 5;
	addi    r4 = r0, 4;
	swc	[r1 + 1] = r2; # memory address 259 (255 + (1 sl 2)) = 5 (all memory banks are updated)
	lwc	r10  = [r1 + 1]; # register(10) = 5
	nop 	0;
	add	r2 = r2, r10; # r2 = 5 + 5 = 10 

	shc	[r1 + 3] = r2; # memory address 261 = 10 (two memory banks are updated)
	...
	swc     [r1 + 3] = r5; # memory address 267 = 98304
	lhc	r20 = [r1 + 6];   # r1 + 6 = r1 + 3 to check signed!
	addi    r5 = r0, 1;
	sli	r5 = r5, 7;
