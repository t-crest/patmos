...
void tte_initialize(unsigned int int_period, unsigned int cl_period, unsigned char CT[], unsigned char VLcount,
  unsigned int max_delay, unsigned int comp_delay, unsigned int precision);// __attribute__((noinline));
...
void tte_start_ticking(char log_sending,char enable_int, void (int_handler)(void));// __attribute__((noinline));
