...
#define HYPER_PERIOD 40000

#define SYNC_ID 0
#define SYNC_PERIOD 20000
#define VL_DYN_RECV_ID 1
#define VL_DYN_RECV_PERIOD 20000
...
#define VL_FILTER_SEND_PERIOD 40000
...
unsigned long long SYNC_sched_insts[SYNC_INSTS_NUM] = {0, 20000};
unsigned long long VL_DYN_RECV_sched_insts[VL_DYN_RECV_INSTS_NUM] = {14093, 34093};
unsigned long long Q_FILTER_sched_insts[Q_FILTER_INSTS_NUM] = {275};
unsigned long long VZ_FILTER_sched_insts[VZ_FILTER_INSTS_NUM] = {34566};
unsigned long long AZ_FILTER_sched_insts[AZ_FILTER_INSTS_NUM] = {654};
unsigned long long VA_FILTER_sched_insts[VA_FILTER_INSTS_NUM] = {1028};
unsigned long long H_FILTER_sched_insts[H_FILTER_INSTS_NUM] = {1402};
unsigned long long VL_FILTER_SEND_sched_insts[VL_FILTER_SEND_INSTS_NUM] = {2137};
