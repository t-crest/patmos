...
tempemu:
	...
	-cd $(HWBUILDDIR) && verilator --cc Patmos.v --top-module Patmos +define+TOP_TYPE=VPatmos -CFLAGS "-Wno-undefined-bool-conversion -O1 -DTOP_TYPE=VPatmos -DVL_USER_FINISH -include VPatmos.h" -Mdir $(HWBUILDDIR) --exe ../Patmos-harness.cpp -LDFLAGS -lelf --trace   
