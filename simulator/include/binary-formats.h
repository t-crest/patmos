...
namespace patmos
{
  ...
  /// The ALUu instruction format (see Patmos TR).
  class aluu_format_t : public binary_format_t
  {
  public:
    /// Construct a new binary format for the instruction using a given opcode.
    /// @param instruction The instruction.
    /// @param opcode The instruction's opcode.
    aluu_format_t(const instruction_t &instruction, word_t opcode);
  ...
  /// The SPCn instruction format (see Patmos TR).
  class spcn_format_t : public binary_format_t
  {
  public:
    /// Construct a new binary format for the instruction using a given opcode.
    /// @param instruction The instruction.
    /// @param opcode The instruction's opcode.
    spcn_format_t(const instruction_t &instruction, word_t opcode);
    ...
    /// @param imm The immediate operand.
    /// @return An encoded instruction word.
    static word_t encode(word_t pred, word_t imm);
  };
  ...
  /// The STC instruction format (see Patmos TR).
  class stc_format_t : public binary_format_t
  {
  public:
    /// Construct a new binary format for the instruction using a given opcode.
    /// @param instruction The instruction.
    /// @param opcode The instruction's opcode.
    stc_format_t(const instruction_t &instruction, word_t opcode);
  ...
  public:
    ...
    /// @param instruction The instruction.
    /// @param opcode The instruction's opcode.
    hlt_format_t(const instruction_t &instruction, word_t opcode);
