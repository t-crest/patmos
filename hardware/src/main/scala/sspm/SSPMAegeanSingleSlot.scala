 ...
 *
 * The core for a shared scratchpad memory with single slot arbitration
 *
 * This is work in progress and will be integrated into the main SSPMAegean.scala
 */
...
class SSPMAegeanSingleSlot(val nCores: Int, val extendedSlotSize: Int) extends Module {
  ...
  // Connect the SSPMConnector with the SSPMAegeanSingleSlot
...
object SSPMAegeanSingleSlotMain {
  def main(args: Array[String]): Unit = {
    println("Generating the SSPMAegeanSingleSlot hardware")
...
/**
 * Test the SSPMAegeanSingleSlot design
 */
class SSPMAegeanSingleSlotTester(dut: SSPMAegeanSingleSlot, size: Int) extends Tester(dut) {
...
object SSPMAegeanSingleSlotTester {
  def main(args: Array[String]): Unit = {
