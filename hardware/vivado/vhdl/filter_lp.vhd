...
-- Generated on: 2018-02-10 18:21:56
-- -------------------------------------------------------------
...
----------------------------------------------------------------
--Module Architecture: filter_lp
----------------------------------------------------------------
ARCHITECTURE rtl OF filter_lp IS
  -- Local Functions
  -- Type Definitions
  TYPE delay_pipeline_type IS ARRAY (NATURAL range <>) OF signed(15 DOWNTO 0); -- sfix16_En15
  -- Constants
  CONSTANT coeff1                         : signed(15 DOWNTO 0) := to_signed(-19834, 16); -- sfix16_En18
  CONSTANT coeff2                         : signed(15 DOWNTO 0) := to_signed(3052, 16); -- sfix16_En18
  CONSTANT coeff3                         : signed(15 DOWNTO 0) := to_signed(3014, 16); -- sfix16_En18
  CONSTANT coeff4                         : signed(15 DOWNTO 0) := to_signed(3085, 16); -- sfix16_En18
  CONSTANT coeff5                         : signed(15 DOWNTO 0) := to_signed(3262, 16); -- sfix16_En18
  CONSTANT coeff6                         : signed(15 DOWNTO 0) := to_signed(3510, 16); -- sfix16_En18
  CONSTANT coeff7                         : signed(15 DOWNTO 0) := to_signed(3832, 16); -- sfix16_En18
  CONSTANT coeff8                         : signed(15 DOWNTO 0) := to_signed(4194, 16); -- sfix16_En18
  CONSTANT coeff9                         : signed(15 DOWNTO 0) := to_signed(4650, 16); -- sfix16_En18
  CONSTANT coeff10                        : signed(15 DOWNTO 0) := to_signed(5117, 16); -- sfix16_En18
  CONSTANT coeff11                        : signed(15 DOWNTO 0) := to_signed(5613, 16); -- sfix16_En18
  CONSTANT coeff12                        : signed(15 DOWNTO 0) := to_signed(6144, 16); -- sfix16_En18
  CONSTANT coeff13                        : signed(15 DOWNTO 0) := to_signed(6672, 16); -- sfix16_En18
  CONSTANT coeff14                        : signed(15 DOWNTO 0) := to_signed(7209, 16); -- sfix16_En18
  CONSTANT coeff15                        : signed(15 DOWNTO 0) := to_signed(7732, 16); -- sfix16_En18
  CONSTANT coeff16                        : signed(15 DOWNTO 0) := to_signed(8250, 16); -- sfix16_En18
  CONSTANT coeff17                        : signed(15 DOWNTO 0) := to_signed(8737, 16); -- sfix16_En18
  CONSTANT coeff18                        : signed(15 DOWNTO 0) := to_signed(9194, 16); -- sfix16_En18
  CONSTANT coeff19                        : signed(15 DOWNTO 0) := to_signed(9621, 16); -- sfix16_En18
  CONSTANT coeff20                        : signed(15 DOWNTO 0) := to_signed(9997, 16); -- sfix16_En18
  CONSTANT coeff21                        : signed(15 DOWNTO 0) := to_signed(10329, 16); -- sfix16_En18
  CONSTANT coeff22                        : signed(15 DOWNTO 0) := to_signed(10606, 16); -- sfix16_En18
  CONSTANT coeff23                        : signed(15 DOWNTO 0) := to_signed(10827, 16); -- sfix16_En18
  CONSTANT coeff24                        : signed(15 DOWNTO 0) := to_signed(10986, 16); -- sfix16_En18
  CONSTANT coeff25                        : signed(15 DOWNTO 0) := to_signed(11081, 16); -- sfix16_En18
  CONSTANT coeff26                        : signed(15 DOWNTO 0) := to_signed(11118, 16); -- sfix16_En18
  CONSTANT coeff27                        : signed(15 DOWNTO 0) := to_signed(11081, 16); -- sfix16_En18
  CONSTANT coeff28                        : signed(15 DOWNTO 0) := to_signed(10986, 16); -- sfix16_En18
  CONSTANT coeff29                        : signed(15 DOWNTO 0) := to_signed(10827, 16); -- sfix16_En18
  CONSTANT coeff30                        : signed(15 DOWNTO 0) := to_signed(10606, 16); -- sfix16_En18
  CONSTANT coeff31                        : signed(15 DOWNTO 0) := to_signed(10329, 16); -- sfix16_En18
  CONSTANT coeff32                        : signed(15 DOWNTO 0) := to_signed(9997, 16); -- sfix16_En18
  CONSTANT coeff33                        : signed(15 DOWNTO 0) := to_signed(9621, 16); -- sfix16_En18
  CONSTANT coeff34                        : signed(15 DOWNTO 0) := to_signed(9194, 16); -- sfix16_En18
  CONSTANT coeff35                        : signed(15 DOWNTO 0) := to_signed(8737, 16); -- sfix16_En18
  CONSTANT coeff36                        : signed(15 DOWNTO 0) := to_signed(8250, 16); -- sfix16_En18
  CONSTANT coeff37                        : signed(15 DOWNTO 0) := to_signed(7732, 16); -- sfix16_En18
  CONSTANT coeff38                        : signed(15 DOWNTO 0) := to_signed(7209, 16); -- sfix16_En18
  CONSTANT coeff39                        : signed(15 DOWNTO 0) := to_signed(6672, 16); -- sfix16_En18
  CONSTANT coeff40                        : signed(15 DOWNTO 0) := to_signed(6144, 16); -- sfix16_En18
  CONSTANT coeff41                        : signed(15 DOWNTO 0) := to_signed(5613, 16); -- sfix16_En18
  CONSTANT coeff42                        : signed(15 DOWNTO 0) := to_signed(5117, 16); -- sfix16_En18
  CONSTANT coeff43                        : signed(15 DOWNTO 0) := to_signed(4650, 16); -- sfix16_En18
  CONSTANT coeff44                        : signed(15 DOWNTO 0) := to_signed(4194, 16); -- sfix16_En18
  CONSTANT coeff45                        : signed(15 DOWNTO 0) := to_signed(3832, 16); -- sfix16_En18
  CONSTANT coeff46                        : signed(15 DOWNTO 0) := to_signed(3510, 16); -- sfix16_En18
  CONSTANT coeff47                        : signed(15 DOWNTO 0) := to_signed(3262, 16); -- sfix16_En18
  CONSTANT coeff48                        : signed(15 DOWNTO 0) := to_signed(3085, 16); -- sfix16_En18
  CONSTANT coeff49                        : signed(15 DOWNTO 0) := to_signed(3014, 16); -- sfix16_En18
  CONSTANT coeff50                        : signed(15 DOWNTO 0) := to_signed(3052, 16); -- sfix16_En18
  CONSTANT coeff51                        : signed(15 DOWNTO 0) := to_signed(-19834, 16); -- sfix16_En18
...
BEGIN
  ...
  product51 <= resize(mul_temp(31 DOWNTO 3), 32);

  mul_temp_1 <= delay_pipeline(49) * coeff50;
  product50 <= resize(mul_temp_1(31 DOWNTO 3), 32);

  mul_temp_2 <= delay_pipeline(48) * coeff49;
  product49 <= resize(mul_temp_2(31 DOWNTO 3), 32);

  mul_temp_3 <= delay_pipeline(47) * coeff48;
  product48 <= resize(mul_temp_3(31 DOWNTO 3), 32);

  mul_temp_4 <= delay_pipeline(46) * coeff47;
  product47 <= resize(mul_temp_4(31 DOWNTO 3), 32);

  mul_temp_5 <= delay_pipeline(45) * coeff46;
  product46 <= resize(mul_temp_5(31 DOWNTO 3), 32);

  mul_temp_6 <= delay_pipeline(44) * coeff45;
  product45 <= resize(mul_temp_6(31 DOWNTO 3), 32);

  mul_temp_7 <= delay_pipeline(43) * coeff44;
  product44 <= resize(mul_temp_7(31 DOWNTO 3), 32);

  mul_temp_8 <= delay_pipeline(42) * coeff43;
  product43 <= resize(mul_temp_8(31 DOWNTO 3), 32);

  mul_temp_9 <= delay_pipeline(41) * coeff42;
  product42 <= resize(mul_temp_9(31 DOWNTO 3), 32);

  mul_temp_10 <= delay_pipeline(40) * coeff41;
  product41 <= resize(mul_temp_10(31 DOWNTO 3), 32);

  mul_temp_11 <= delay_pipeline(39) * coeff40;
  product40 <= resize(mul_temp_11(31 DOWNTO 3), 32);

  mul_temp_12 <= delay_pipeline(38) * coeff39;
  product39 <= resize(mul_temp_12(31 DOWNTO 3), 32);

  mul_temp_13 <= delay_pipeline(37) * coeff38;
  product38 <= resize(mul_temp_13(31 DOWNTO 3), 32);

  mul_temp_14 <= delay_pipeline(36) * coeff37;
  product37 <= resize(mul_temp_14(31 DOWNTO 3), 32);

  mul_temp_15 <= delay_pipeline(35) * coeff36;
  product36 <= resize(mul_temp_15(31 DOWNTO 3), 32);

  mul_temp_16 <= delay_pipeline(34) * coeff35;
  product35 <= resize(mul_temp_16(31 DOWNTO 3), 32);

  mul_temp_17 <= delay_pipeline(33) * coeff34;
  product34 <= resize(mul_temp_17(31 DOWNTO 3), 32);

  mul_temp_18 <= delay_pipeline(32) * coeff33;
  product33 <= resize(mul_temp_18(31 DOWNTO 3), 32);

  mul_temp_19 <= delay_pipeline(31) * coeff32;
  product32 <= resize(mul_temp_19(31 DOWNTO 3), 32);

  mul_temp_20 <= delay_pipeline(30) * coeff31;
  product31 <= resize(mul_temp_20(31 DOWNTO 3), 32);

  mul_temp_21 <= delay_pipeline(29) * coeff30;
  product30 <= resize(mul_temp_21(31 DOWNTO 3), 32);

  mul_temp_22 <= delay_pipeline(28) * coeff29;
  product29 <= resize(mul_temp_22(31 DOWNTO 3), 32);

  mul_temp_23 <= delay_pipeline(27) * coeff28;
  product28 <= resize(mul_temp_23(31 DOWNTO 3), 32);

  mul_temp_24 <= delay_pipeline(26) * coeff27;
  product27 <= resize(mul_temp_24(31 DOWNTO 3), 32);

  mul_temp_25 <= delay_pipeline(25) * coeff26;
  product26 <= resize(mul_temp_25(31 DOWNTO 3), 32);

  mul_temp_26 <= delay_pipeline(24) * coeff25;
  product25 <= resize(mul_temp_26(31 DOWNTO 3), 32);

  mul_temp_27 <= delay_pipeline(23) * coeff24;
  product24 <= resize(mul_temp_27(31 DOWNTO 3), 32);

  mul_temp_28 <= delay_pipeline(22) * coeff23;
  product23 <= resize(mul_temp_28(31 DOWNTO 3), 32);

  mul_temp_29 <= delay_pipeline(21) * coeff22;
  product22 <= resize(mul_temp_29(31 DOWNTO 3), 32);

  mul_temp_30 <= delay_pipeline(20) * coeff21;
  product21 <= resize(mul_temp_30(31 DOWNTO 3), 32);

  mul_temp_31 <= delay_pipeline(19) * coeff20;
  product20 <= resize(mul_temp_31(31 DOWNTO 3), 32);

  mul_temp_32 <= delay_pipeline(18) * coeff19;
  product19 <= resize(mul_temp_32(31 DOWNTO 3), 32);

  mul_temp_33 <= delay_pipeline(17) * coeff18;
  product18 <= resize(mul_temp_33(31 DOWNTO 3), 32);

  mul_temp_34 <= delay_pipeline(16) * coeff17;
  product17 <= resize(mul_temp_34(31 DOWNTO 3), 32);

  mul_temp_35 <= delay_pipeline(15) * coeff16;
  product16 <= resize(mul_temp_35(31 DOWNTO 3), 32);

  mul_temp_36 <= delay_pipeline(14) * coeff15;
  product15 <= resize(mul_temp_36(31 DOWNTO 3), 32);

  mul_temp_37 <= delay_pipeline(13) * coeff14;
  product14 <= resize(mul_temp_37(31 DOWNTO 3), 32);

  mul_temp_38 <= delay_pipeline(12) * coeff13;
  product13 <= resize(mul_temp_38(31 DOWNTO 3), 32);

  mul_temp_39 <= delay_pipeline(11) * coeff12;
  product12 <= resize(mul_temp_39(31 DOWNTO 3), 32);

  mul_temp_40 <= delay_pipeline(10) * coeff11;
  product11 <= resize(mul_temp_40(31 DOWNTO 3), 32);

  mul_temp_41 <= delay_pipeline(9) * coeff10;
  product10 <= resize(mul_temp_41(31 DOWNTO 3), 32);

  mul_temp_42 <= delay_pipeline(8) * coeff9;
  product9 <= resize(mul_temp_42(31 DOWNTO 3), 32);

  mul_temp_43 <= delay_pipeline(7) * coeff8;
  product8 <= resize(mul_temp_43(31 DOWNTO 3), 32);

  mul_temp_44 <= delay_pipeline(6) * coeff7;
  product7 <= resize(mul_temp_44(31 DOWNTO 3), 32);

  mul_temp_45 <= delay_pipeline(5) * coeff6;
  product6 <= resize(mul_temp_45(31 DOWNTO 3), 32);

  mul_temp_46 <= delay_pipeline(4) * coeff5;
  product5 <= resize(mul_temp_46(31 DOWNTO 3), 32);

  mul_temp_47 <= delay_pipeline(3) * coeff4;
  product4 <= resize(mul_temp_47(31 DOWNTO 3), 32);

  mul_temp_48 <= delay_pipeline(2) * coeff3;
  product3 <= resize(mul_temp_48(31 DOWNTO 3), 32);

  mul_temp_49 <= delay_pipeline(1) * coeff2;
  product2 <= resize(mul_temp_49(31 DOWNTO 3), 32);

  mul_temp_50 <= delay_pipeline(0) * coeff1;
  product1 <= resize(mul_temp_50(31 DOWNTO 3), 32);
